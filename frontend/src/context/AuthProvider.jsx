...
export const AuthProvider = ({ children }) => {
  ...
  useEffect(() => {
    ...
    const fetchProfile = async () => {
      try {
        const { data } = await axios.get("https://sufiyanblogapp.onrender.com/api/blog/my-profile", {
          headers: {
    ...
    const fetchBlog = async () => {
      try {
        const response = await axios.get("https://sufiyanblogapp.onrender.com/api/blog/all-blogs");
